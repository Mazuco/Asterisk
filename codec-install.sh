...
#
# Changed for Asterisk 16 LTS and 18 LTS by Vitor Mazuco 2022 <vitor.mazuco@gmail.com>


# Codecs installed from http://asterisk.hosting.lv/
# Supports 64-bit Asterisk v.1.8, 11, 12, 13, 14, 15, 16 and 18
...
echo "---  Supports Asterisk v.1.8, 11, 12, 13, 14, 15, 16 and 18 only"
